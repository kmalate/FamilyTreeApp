...
- Create Angular project with ng: `ng new familytreeapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`familytreeapp.client.esproj`).
